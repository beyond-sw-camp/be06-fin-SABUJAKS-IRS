...
### 주요 기능
1. **공고**
	- 공고 이미지를 업로드하거나 제공되는 공고 템플릿을 통해 공고를 작성할 수 있습니다.
 	- 10여 가지 지원서 항목 중 필요한 항목을 선택하고, 자기소개서 문항과 글자 수를 직접 입력하여 해당 공고에 맞는 지원서를 구성할 수 있습니다.
3. **지원서**
   	- 각 공고에 지원하기 위한 지원서를 작성할 때, 미리 작성한 통합 지원서 내용을 불러와 간편하게 지원서를 작성할 수 있습니다.

5. **면접 일정 조율**
   	- (신입) 채용 담당자가 확정한 면접 일정을 이메일 또는 사이트 내 알림 관리를 통해 안내받습니다.
   	- (경력) 채용 담당자가 제안한 면접 일정을 이메일 또는 사이트 내 알림 관리를 통해 안내받고, 해당 일정을 다시 조율할 수 있습니다.
7. **화상 면접**
   	- 공고 작성 시 선택한 채용 절차에 따라 1차, 2차 화상 면접을 진행할 수 있습니다.
   	- 면접에 참여하는 면접관은 면접 평가표를 작성하여 채용 담당자에게 전달할 수 있습니다.
9. **결과 알림**
	- 공고 작성 시 선택한 결과 발표일 오후 4시에 일괄적으로 전송되는 결과 안내 이메일 또는 사이트 내 알림 관리를 통해 결과를 확인 할 수 있습니다.
<br><br><br><br>
