...
:root {
  ...
  --breadcrumbs-bar-background: rgba(244, 244, 248, 0.8);
  ...
  0 2px 10px rgba(0, 0, 20, 0.05), inset 0 -1px 2px hsla(0, 0%, 100%, 0.025);
  --dialog-backdrop-filter: brightness(3) blur(50px);
  --dialog-box-shadow: 0 10px 40px rgba(0, 0, 20, 0.15),
  0 2px 15px rgba(0, 0, 20, 0.05), inset 0 0 2px 2px hsla(0, 0%, 100%, 0.025);
  ...
  --pane-link-color: #000;
  --pane-link-color--visited: #000;
  --card-background: var(--background);
  --card-background--hover: transparent;
  --card-background--active: transparent;
  --card-border-color: rgba(175, 175, 207, 0.25);
  --card-border-color--hover: rgba(175, 175, 207, 0.5);
  --card-border-color--active: rgba(175, 175, 207, 0.75);
  ...
  --tabs-item-background--selected: #fff;
  ...
  --light-bg-color: #eee;
  --light-bg-color--hover: hsla(0, 0%, 100%, 0.65);
  --add-item-btn-decorator-border-color: #acb;
  --add-item-btn-decorator-bg-color: hsla(84, 45%, 96%, 0.75);
  ...
  --button-background: rgba(175, 175, 207, 0.1);
  --button-background--hover: rgba(175, 175, 207, 0.175);
  --button-background--active: rgba(175, 175, 207, 0.25);
  --button-box-shadow--focus: rgba(175, 175, 207, 0.1);
  --item-background--hover: rgba(175, 175, 207, 0.15);
  --item-background--active: rgba(175, 175, 207, 0.225);
  --item-box-shadow--focus: rgba(175, 175, 207, 0.105);
...
.app-theme-picker__picker[data-theme='none'] ::backdrop,
:root ::backdrop {
  --dialog-backdrop-background: rgba(46, 46, 56, 0.8);
}
...
.jenkins-checkbox input:checked:active + label:before,
.jenkins-checkbox input:checked:focus + label:before,
...
.jenkins-button:focus-visible {
  outline: none;
}
.jenkins-button:not(:disabled):focus-visible:before,
.jenkins-button:not(:disabled):hover:before {
  background-color: var(--item-background--hover);
}
.jenkins-button:not(:disabled):active {
  outline: none !important;
  z-index: 1;
}
.jenkins-button:not(:disabled):active:before {
  background-color: var(--item-background--active);
}
.jenkins-button:not(:disabled):active:after {
  box-shadow: 0 0 0 0.33rem var(--item-box-shadow--focus);
}
.jenkins-button:not(:disabled):focus-visible:after {
...
.jenkins-button--primary:not(:disabled):hover:before {
  opacity: 0.9;
}
.jenkins-button--primary:not(:disabled):active:before,
.jenkins-button--primary:not(:disabled):focus-visible:before {
  opacity: 0.8;
}
.jenkins-button--primary:not(:disabled):active:after,
.jenkins-button--primary:not(:disabled):focus-visible:after {
  box-shadow: 0 0 0 0.33rem var(--accent-color);
  opacity: 0.2;
}
.jenkins-button--tertiary:before {
  background: transparent;
}
.jenkins-button[class*='color']:before {
  background: currentColor !important;
  opacity: 0.1;
}
.jenkins-button[class*='color']:after {
  box-shadow: 0 0 0 0.66rem currentColor;
  opacity: 0;
}
.jenkins-button[class*='color']:not(:disabled):hover:before {
  opacity: 0.15;
}
.jenkins-button[class*='color']:not(:disabled):active:before {
  opacity: 0.2;
}
.jenkins-button[class*='color']:not(:disabled):active:after {
...
.jenkins-button--primary[class*='color']:not(:disabled):hover:before {
  opacity: 0.9;
}
.jenkins-button--primary[class*='color']:not(:disabled):active:before,
.jenkins-button--primary[class*='color']:not(:disabled):focus-visible:before {
  opacity: 0.8;
}
.jenkins-button--tertiary[class*='color']:before {
  opacity: 0;
}
.jenkins-buttons-row {
  align-items: center;
...
.jenkins-buttons-row--equal-width .jenkins-button {
  min-width: 5.625rem;
}
.jenkins-copy-button .jenkins-copy-button__icon {
  height: 1.125rem;
  position: relative;
  transition: var(--standard-transition);
  width: 0.9rem;
}
.jenkins-copy-button .jenkins-copy-button__icon:after,
.jenkins-copy-button .jenkins-copy-button__icon:before {
  border: 0.1rem solid;
...
.jenkins-copy-button .jenkins-copy-button__icon:before {
  clip-path: polygon(100% 0, 100% 22.5%, 22.5% 22.5%, 32.5% 100%, 0 100%, 0 0);
  left: 1%;
  top: 4%;
}
.jenkins-copy-button .jenkins-copy-button__icon:after {
...
.jenkins-copy-button:hover .jenkins-copy-button__icon:before {
  transform: translate(7%, 4.5%);
}
.jenkins-copy-button:hover .jenkins-copy-button__icon:after {
  transform: translate(-7%, -4.5%);
}
.jenkins-copy-button:active .jenkins-copy-button__icon {
...
.jenkins-validate-button__container > .jenkins-button {
  float: right;
}
.advanced-button svg,
.hetero-list-add svg {
...
.advanced-button:not([data-expanded='true']):active svg,
.hetero-list-add:not([data-expanded='true']):active svg {
  translate: 0 0.125rem;
}
.advanced-button[data-expanded='true'] svg,
.hetero-list-add[data-expanded='true'] svg {
  rotate: 180deg;
}
...
.jenkins-split-button > :first-child {
  border-bottom-right-radius: 0.2rem;
  border-top-right-radius: 0.2rem;
}
.jenkins-split-button > .jenkins-button:last-of-type {
  border-bottom-left-radius: 0.2rem;
  border-top-left-radius: 0.2rem;
  padding: 0 5px;
}
.jenkins-split-button > .jenkins-button:last-of-type svg {
  height: 0.8rem;
  width: 0.8rem;
}
.stop-button-link:after,
.stop-button-link:before {
  border-radius: inherit;
  content: '';
  inset: 0;
  pointer-events: none;
...
.stop-button-link:focus-visible {
  outline: none;
}
.stop-button-link:not(:disabled):focus-visible:before,
.stop-button-link:not(:disabled):hover:before {
  background-color: var(--item-background--hover);
}
.stop-button-link:not(:disabled):active {
  outline: none !important;
  z-index: 1;
}
.stop-button-link:not(:disabled):active:before {
  background-color: var(--item-background--active);
}
.stop-button-link:not(:disabled):active:after {
  box-shadow: 0 0 0 0.33rem var(--item-box-shadow--focus);
}
.stop-button-link:not(:disabled):focus-visible:after {
  box-shadow: 0 0 0 0.2rem var(--text-color) !important;
  opacity: 1 !important;
}
.stop-button-link svg * {
  stroke-width: 40px;
}
@property --opacity {
  syntax: '<angle>';
...
.app-sign-in-register__branding:after,
.app-sign-in-register__branding:before {
  aspect-ratio: 1;
  content: '';
  min-height: 130%;
  min-width: 130%;
...
.app-sign-in-register__branding__starburst {
  -webkit-backdrop-filter: invert(2%) blur(100px);
...
.app-sign-in-register__branding img {
  height: 25vh;
  max-height: 30rem;
  min-height: 15rem;
  z-index: 1;
...
.app-sign-in-register__content-inner h1 {
...
.app-sign-in-register__content-inner input {
  border-radius: 0.66rem;
  font-size: 0.95rem;
...
.app-sign-in-register__content-inner .app-sign-in-register__form-label {
  display: block;
  font-size: 0.95rem;
  font-weight: 500;
  margin-bottom: 0.5rem;
}
.app-sign-in-register__content-inner button {
  font-size: 0.95rem;
  padding: 0.9rem 1rem;
}
.app-sign-in-register__content-inner form {
  display: contents;
}
.app-sign-in-register__content-inner .app-sign-in-register__switcher {
  align-items: center;
  display: flex;
  justify-content: center;
  position: relative;
}
.app-sign-in-register__content-inner .app-sign-in-register__switcher:before {
...
.app-sign-in-register__content-inner .app-sign-in-register__switcher a {
  color: var(--link-color);
  font-size: 0.95rem;
  font-weight: var(--link-font-weight);
  font-weight: 500;
...
.app-sign-in-register__content-inner .app-sign-in-register__switcher a:link {
  color: var(--link-color);
}
.app-sign-in-register__content-inner .app-sign-in-register__switcher a:visited {
  color: var(--link-visited-color);
}
.app-sign-in-register__content-inner .app-sign-in-register__switcher a:focus,
.app-sign-in-register__content-inner .app-sign-in-register__switcher a:hover {
  color: var(--link-color--hover);
  -webkit-text-decoration: var(--link-text-decoration--hover);
  text-decoration: var(--link-text-decoration--hover);
}
.app-sign-in-register__content-inner .app-sign-in-register__switcher a:active {
  color: var(--link-color--active);
  -webkit-text-decoration: var(--link-text-decoration--active);
  text-decoration: var(--link-text-decoration--active);
}
...
.app-sign-in-register__content-inner .app-sign-in-register__switcher a:before {
  background-color: var(--background);
  content: '';
  inset: 0 -0.5rem;
  position: absolute;
...
.app-sign-in-register__content-inner .app-sign-in-register__switcher a:after {
...
.app-sign-in-register__content-inner .jenkins-checkbox {
  font-size: 0.95rem;
}
.app-sign-in-register__content-inner > div:empty {
  display: none;
}
...
.app-sign-in-register__error:empty {
  display: none;
}
.app-sign-in-register__error:not(:empty) + input {
  margin-top: 0.7rem;
}
...
#passwordStrengthWrapper #passwordStrength {
  transition: var(--standard-transition);
}
.simple-page h1 {
  font-size: 24px;
...
.simple-page .safe-restarting strong {
  font-weight: 500;
}
