        ...
        <div class="resume-view-container">
            <div class="base profile image">
                <div class="container-p">
                    <div v-if="showPersonalInfo" class="photo"><img name="user_photo" :src="personalInfo.profileImg">
                    </div>
                    <div v-if="showPersonalInfo" class="info-container">
                        <div class="info-general">
                            <div class="item name">{{ personalInfo.name }}</div>
                            <div class="item sex">{{ personalInfo.gender }}</div>
                            <div class="item year">{{ personalInfo.birth }}</div>
                            <div class="item age">(만 {{ calculateAge(personalInfo.birth) }}세)</div>
                        </div>
                        <div class="info-detail">
                            <div class="item">
                                <div class="label">휴대폰</div>
                                <div class="value">{{ personalInfo.phone }}</div>
                            </div>
                            <div class="item">
                                <div class="label">Email</div>
                                <div class="value">
                                    <a href="mailto:eunjoo.nine@gmail.com">{{ personalInfo.email }}</a>
                                </div>
                            </div>
                            <div class="item-address">
                                <div class="label">주소</div>
                                <div class="value">{{ personalInfo.address }}</div>
                            </div>
            ...
            <div v-if="showEducation" class="base education">
                ...
                <div class="list list-education">
                    <div class="item" v-for="(education, index) in educations" :key="index">
                    <div class="date">
            ...
            <div v-if="showPersonalHistory" class="base career">
                ...
                <div class="list list-education">
                    <div class="item" v-for="(personalHistory, index) in personalHistories" :key="index">
                        <div class="date">
            ...
            <div v-if="showInternsActivity" class="base intern">
                ...
                <div class="list list-intern">
                    <div class="item" v-for="(internsActivity, index) in internsActivities" :key="index">
                        <div class="date">
            ...
            <div v-if="showTraining" class="base learn">
                ...
                <div class="list list-learn">
                    <div class="item" v-for="(training, index) in trainings" :key="index">
            ...
            <div v-if="showCertification" class="base certificate">
                ...
                <div class="list list-certificate">
                    <div class="item" v-for="(certification, index) in certifications" :key="index">
            ...
            <div v-if="showAward" class="base awards">
                ...
                <div class="list list-awards">
                    <div class="item" v-for="(award, index) in awards" :key="index">
                        <div class="date">
                            {{ award.year }}
                        </div>
                        <div class="content">
            ...
            <div v-if="showStudyingAbroad" class="base experience">
                ...
                <div class="list list-experience">
                    <div class="item" v-for="(studyingAbroad, index) in studyingAbroads" :key="index">
                        <div class="date">
            ...
            <div v-if="showLanguage" class="base career">
                ...
                <div class="list list-education">
                    <div class="item" v-for="(language, index) in languages" :key="index">
                        <div class="date">
            ...
            <div v-if="showCustomLetter" class="base introduction">
                ...
                <ul class="list list-introduction">
                    <li v-for="(customLetter, index) in customLetters" :key="index" class="item">
            ...
            <div v-if="showPreferentialEmp" class="base jobpreference">
                ...
                <table class="table table-special">
                    ...
                    <tbody>
                        <tr>
                            <th>보훈대상 여부</th>
                            <td>{{ preferentialEmp.veterans ? 'O' : 'X'}}</td>
                            <th>취업보호대상 여부</th>
                            <td>{{ preferentialEmp.protection ? 'O' : 'X'}}</td>
                            <th>고용지원금대상 여부</th>
                            <td>{{ preferentialEmp.subsidy ? 'O' : 'X'}}</td>
                        </tr>
                        <tr>
                            <th>병역사항</th>
                            <td v-if="preferentialEmp.militaryClass === '군필'" colspan="3">
                                {{ preferentialEmp.military 
                                ? preferentialEmp.militaryClass : 'X'}}
                                ({{ preferentialEmp.militaryStart }} ~ {{ preferentialEmp.militaryEnd }}) 
                                [{{ preferentialEmp.militaryRank }} / {{ preferentialEmp.militaryType }}]
                            </td>
                            <td v-else colspan="3">
                                {{ preferentialEmp.military 
                                ? preferentialEmp.militaryClass : 'X'}} </td>
                            <th>장애여부</th>
                            <td>{{ preferentialEmp.disability ? preferentialEmp.disabilityDegree : 'X'}}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
const personalHistories = ref([]);
const internsActivities = ref([]);
const studyingAbroads = ref([]);
const languages = ref([]);
const certifications = ref([]);
const trainings = ref([]);
const awards = ref([]);
const customLetters = ref({});
const portfolios = ref([]);

onMounted(() => { 
    if(Array.isArray(props.resume.trainings) && props.resume.trainings.length > 0 ){
        showTraining.value = true
        trainings.value = props.resume.trainings
    }
    if(props.resume.personalInfo != null){
        showPersonalInfo.value = true
        personalInfo.value = props.resume.personalInfo;
    }
    if(Array.isArray(props.resume.educations) && props.resume.educations.length > 0){
        showEducation.value = true
        educations.value = props.resume.educations;
    }
    if(props.resume.preferentialEmp != null) {
        showPreferentialEmp.value = true
        preferentialEmp.value = props.resume.preferentialEmp
    }
    if(Array.isArray(props.resume.personalHistories) && props.resume.personalHistories.length > 0) {
        showPersonalHistory.value = true;
        personalHistories.value = props.resume.personalHistories
    }
    if(props.resume.internsActivities != null) {
        showInternsActivity.value = true;
        internsActivities.value = props.resume.internsActivities
    }
    if (Array.isArray(props.resume.studyingAbroads) && props.resume.studyingAbroads.length > 0) {
        showStudyingAbroad.value = true;
        studyingAbroads.value = props.resume.studyingAbroads;
    }
    if (Array.isArray(props.resume.certifications) && props.resume.certifications.length > 0) {
        showCertification.value = true;
        certifications.value = props.resume.certifications;
    }
    if (Array.isArray(props.resume.customLetters) && props.resume.customLetters.length > 0) {
        showCustomLetter.value = true;
        customLetters.value = props.resume.customLetters;
    }
    if (Array.isArray(props.resume.awards) && props.resume.awards.length > 0) {
        showAward.value = true;
        awards.value = props.resume.awards;
    }
    if (props.resume.languages != null) {
        showLanguage.value = true;
        languages.value = props.resume.languages;
    }
    if (Array.isArray(props.resume.portfolios) && props.resume.portfolios.length > 0) {
        showPortfolio.value = true;
        portfolios.value = props.resume.portfolios;
    }
    console.log(props.resume)
    console.log(customLetters.value)
});
