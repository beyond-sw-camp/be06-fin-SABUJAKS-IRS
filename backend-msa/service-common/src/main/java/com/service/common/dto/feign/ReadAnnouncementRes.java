...
@AllArgsConstructor
@Builder
public class ReadAnnouncementRes {
    ...
    /*******공고 쪽 정보*******/
    // 공고 기본 설정
    private String announcementTitle; // 공고제목
    ...
    // 인사담당자/기업정보
    private String recruiterName; // 인사담당자명
    private String recruiterContact; // 인사담당자 연락처
    private String recruiterEmail; // 인사담당자 이메일
    ...
    private List<ReadBenefitCategoryRes> companyBenefitsDataList; // 복리후생 카테고리 리스트
