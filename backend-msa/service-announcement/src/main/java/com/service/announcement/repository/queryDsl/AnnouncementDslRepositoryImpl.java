//package com.service.announcement.repository.queryDsl;
//
...
//
//    @Override
//    public Page<Announcement> search(Pageable pageable, SearchAnnouncementReq searchAnnouncementReq) {
//        BooleanExpression predicate = createPredicate(searchAnnouncementReq);
//
...
//                .where(predicate)
//                .orderBy(getSortOrder(searchAnnouncementReq)) // 정렬 기준 적용
