...
public class AnnouncementService {
    ...
    public ReadInfoRes readRecruiterInfo(Long recruiterIdx) throws BaseException {
        // 채용담당자 확인
        Optional<Recruiter> resultRecruiter = recruiterRepository.findByRecruiterIdx(recruiterIdx);
        if(resultRecruiter.isPresent()) {
    ...
    public CompanyInfoRes readCompanyInfo(Long recruiterIdx) throws BaseException {
        // 채용담당자 확인
        Optional<Recruiter> resultRecruiter = recruiterRepository.findByRecruiterIdx(recruiterIdx);
        if(resultRecruiter.isPresent()) {
            // 채용담당자가 등록한 기업 확인
