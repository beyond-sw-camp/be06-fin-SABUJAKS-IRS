...
import com.example.api.domain.resume.model.response.AwardReadRes;
import com.example.api.domain.resume.model.response.CertificationReadRes;
import com.example.api.domain.resume.model.response.InternsActivityReadRes;
import com.example.api.domain.resume.model.response.StudyingAbroadReadRes;
import lombok.*;
