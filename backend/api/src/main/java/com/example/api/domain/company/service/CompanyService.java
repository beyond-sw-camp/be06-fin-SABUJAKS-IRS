package com.example.api.domain.company.service;
...
import com.example.common.domain.company.repository.CompanyBenefitsRepository;
import com.example.common.domain.company.repository.CompanyImgRepository;
...
public class CompanyService {
    ...
    public CompanyService(RecruiterRepository recruiterRepository, CompanyRepository companyRepository, CompanyImgRepository companyImgRepository, CompanyBenefitsRepository companyBenefitsRepository, CompanyVerifyRepository companyVerifyRepository, BaseInfoRepository baseInfoRepository) {
        this.recruiterRepository = recruiterRepository;
        this.companyRepository = companyRepository;
        this.companyImgRepository = companyImgRepository;
        this.companyBenefitsRepository = companyBenefitsRepository;
