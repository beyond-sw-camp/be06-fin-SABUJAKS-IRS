package com.example.api.domain.auth.controller;

import com.example.api.domain.auth.model.response.*;
...
import com.example.api.domain.auth.service.AuthService;
import com.example.api.domain.auth.service.CompanyVerifyService;
import com.example.api.domain.auth.service.EmailVerifyService;
...
//            headers.setLocation(URI.create("http://localhost:3000/seeker/login?email=true"));
            headers.setLocation(URI.create("https://www.sabujaks-irs.kro.kr/seeker/login?email=true"));
            return new ResponseEntity<>(headers, HttpStatus.FOUND);
        } else {
//            headers.setLocation(URI.create("http://localhost:3000/seeker/login?error=true"));
