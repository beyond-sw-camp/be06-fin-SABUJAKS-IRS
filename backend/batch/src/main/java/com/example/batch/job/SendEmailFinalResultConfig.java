...
public class SendEmailFinalResultConfig {
    ...
    public SendEmailFinalResultConfig(JobRepository jobRepository, PlatformTransactionManager transactionManager, EmailReader emailReader, EmailWriter emailWriter, EmailFinalResultProcessor emailFinalResultProcessor) {
        this.jobRepository = jobRepository;
        this.transactionManager = transactionManager;
        this.emailReader = emailReader;
        this.emailWriter = emailWriter;
        this.emailFinalResultProcessor = emailFinalResultProcessor;
    }
